...
<head>
  ...
  <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" action="{{ route('user.register.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p class="text-inverse text-left"><a href="{{ route('user.login') }}"><b>Already have an account? LogIn Here</b></a></p>
                                    </div>
                                    {{-- <div class="col-md-2">
