...
<head>
    <title>{{ $title ?? ''}} :: {{ App\Models\Setting::setting()->site_name ?? 'Admin Pannel' }}</title>
    ...
    <link rel="icon" href="{{ App\Models\Setting::setting()->favicon ?? asset('assets/images/favicon.ico') }}" type="image/x-icon">
    <!-- Google font-->
