    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <a type="button" href="{{ route('roles.index') }}" class="btn waves-effect waves-light btn-dark btn-outline-dark float-right"><i class="ti-arrow-circle-left"> Back </i></a>
                </div>
            </div>
        </div>
            ...
            <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-body" align="center">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="name" value="{{ old('name', $role->name) }}"
